(function(global) {
    ...
    ym.modules.define("system.nextTick", [], function(e) {
      ...
      function(e) {
        ...
        o.prototype.requireSync = function(e) {
          ...
          var t = [ym.env.server.url, ym.env.server.path, "images", this._name.replace(/\./g, "_") + "_"].join("/");
          return {
            get: function(n) {
        ...
        function n(e, n) {
          ...
          function u(e) {
            function t(e) {
              p--;
              for (var t = [], n = 0, r = e.length - 1; n < r; ++n) {
                var o = h[e[n][0]],
                  i = e[n][1];
                if (o) {
  ...
  ! function(e, t, n) {
    ...
    function(e) {
      ...
      function n(e) {
        return e = encodeURIComponent(e), ym.modules.require(["util.jsonp", "system.ModuleLoader"]).spread(function(t, n) {
          var r = ym.env.server;
          return t({
            url: r.url + "/map.js",
            paddingKey: "ym_map_fallback_" + e,
            requestParams: {
              filter: e,
              mode: r.params.mode,
              version: r.version
      ...
      ym.modules.define("util.id", [], function(e) {
        ...
        e({
          parse: function(e, n, r, o) {
            n = n || "&", r = r || "=", o = o || {};
            for (var i, s, a, u = o.decodeURIComponent || decodeURIComponent, c = {}, l = e.split(n), f = 0; f < l.length; ++f) i = l[f].split(r),
              s = u(i[0]), a = u(i.slice(1).join(r)), t(c[s]) ? c[s].push(a) : c.hasOwnProperty(s) ? c[s] = [c[s], a] : c[s] = a;
            return c
          },
        ...
        function i(e) {
          var o, i, a = "undefined" == typeof e.checkResponse || e.checkResponse,
            l = e.responseFieldName || "response",
            f = e.requestParams ? "&" + n.stringify(e.requestParams, null, null, {
              joinArrays: !0
            }) : "",
            d = ym.vow.defer(),
            p = d.promise(),
    ...
    function(e) {
      ym.modules.define("system.supports.css", [], function(e) {
        ...
        e({
          ...
          hasWebGl: function() {
            return "webgl" in i || (i.webgl = n(!0)), i.webgl
          },
          hasVml: function() {
            if (!("vml" in i)) {
              var e, t = !1,
      ...
      }), ym.modules.require(["system.supports.css", "system.supports.graphics"], function(e, t) {
        ym.supports = {
          css: e,
          graphics: t,
          printPatchNeeded: !e.checkProperty("printColorAdjust") && !ym.env.enterprise
        }
      })
    }(this);
  setupAsync({
    ...
    "hosts": {
      ...
      "panoramasApi": "https://panoramas.api-maps.yandex.ru/",
    ...
    "token": "247dc3ac52b8bbbc8d23341a4801f89c",
    "sign": (function(r) {
      function t(e) {
      ...
      function e() {
        for (var r = ["9", "7", "7", "e", "d", "0", "9", "5", "3", "2", "5", "d", "e", "3", "4", "e", "1", "0", "4", "7", "4", "7", "c", "4", "b", "1", "b", "1", "3", "3", "a", "0", "b", "4", "f", "a", "b", "b", "f", "b"], t = [
            [(function() {
              try {
            ...
            })() + 23, SVGLength.SVG_LENGTHTYPE_EXS + 34],
            [DOMException.QUOTA_EXCEEDED_ERR - 3, SVGLength.SVG_LENGTHTYPE_UNKNOWN],
            [SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMAXYMAX - 1, DOMException.NO_MODIFICATION_ALLOWED_ERR - 5]
          ], n = 0; n < t.length; n++) {
          var e = t[n][0],
            o = t[n][1],
            i = r[e];
    ...
    "version": "2.1.42",
    "majorVersion": "2.1",
    "cssPrefix": "ymaps-2-1-42-",
    "server": {
      "url": "//api-maps.yandex.ru/2.1.42",
      "path": "./build/release/",
      "params": {},
      "version": 1475068985742
    },
    "preload": {
      "load": "package.full"
    },
